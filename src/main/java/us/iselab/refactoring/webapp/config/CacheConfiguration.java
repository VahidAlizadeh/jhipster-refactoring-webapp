...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("JHipsterRefactoringWebapp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("JHipsterRefactoringWebapp");
        ...
        config.getMapConfigs().put("us.iselab.refactoring.webapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
